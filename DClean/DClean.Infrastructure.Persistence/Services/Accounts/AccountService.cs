...
namespace DClean.Infrastructure.Persistence.Services
{
    public class AccountService : IAccountService
    {
        ...
        private async Task<JwtSecurityToken> GenerateJWToken(ApplicationUser user)
        {
            ...
            .Union(userClaims)
            .Union(roleClaims);
            if (user?.TenantId.HasValue ?? false)
            {
                claims.Union(new[] {
            ...
            var jwtSecurityToken = new JwtSecurityToken(
                ...
                claims: claims,
                expires: _jwtSettings.DurationInMinutes.HasValue ? DateTime.UtcNow.AddMinutes(_jwtSettings.DurationInMinutes.Value) : null,
